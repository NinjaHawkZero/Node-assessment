...
function authUser(req, res, next) {
  //BUG FIX #1:
  try {//was req.body._token and req.query._token
    //Test: test authuser function, testing route that uses function, write the key of token wrong, expecting it to fail
